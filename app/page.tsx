                ...
                <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 md:px-8">
                    ...
                    <div className="hidden items-center gap-3 md:flex">
                        ...
                        <Link href="/onboarding/account">
                            <Button
                                size="sm"
                                className="bg-teal-400 text-[#06251f] hover:bg-teal-300"
                            >
                                Get API access
                            </Button>
                        </Link>
            ...
            >
                <div className="mx-auto max-w-4xl px-5 pb-16 pt-16 text-center md:px-8 md:pb-20 md:pt-24">
                    ...
                    <p className="mx-auto mt-5 max-w-2xl text-balance text-[15px] leading-relaxed text-slate-400 md:text-lg">
                        LDB Africa is the B2B platform that lets your business
                        issue dedicated virtual accounts (DVAs) to your own
                        customers — with real-time reconciliation, signed
                        webhooks, and edge-case handling built in. You own the
                        customer relationship; we power the rails.
                    </p>

                    <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                        <Button
                            size="lg"
                            className="w-full bg-teal-400 text-[#06251f] hover:bg-teal-300 sm:w-auto"
                        >
                            Get API access
                        </Button>
                        <Button
                    ...
                    <div className="overflow-hidden rounded-xl border border-white/10 bg-[#0d1220] shadow-[0_0_0_1px_rgba(45,212,191,0.04)]">
                        ...
                        <div className="flex flex-col items-center gap-3 border-t border-white/10 px-5 py-4 text-center md:flex-row md:justify-between md:px-8 md:text-left">
                            <span className="font-mono text-xs text-slate-500">
                                POST https://your-app.com/webhooks · 200 OK ·
                                124ms
                            </span>
                ...
                <div className="grid grid-cols-1 gap-10 rounded-2xl border border-white/10 bg-[#0d1220]/60 p-6 md:grid-cols-2 md:items-center md:gap-12 md:p-14">
                    <div>
                        ...
                        <p className="mt-4 text-[15px] leading-relaxed text-slate-400">
                            Register one of your customers, get back a dedicated
                            account number to show them, and start receiving
                            real-time webhooks at your endpoint for every
                            inbound transfer. Go live in a day.
                        </p>
                        <Button
                            variant="outline"
...
function DemoPanel({
    ...
    return (
        <div className="flex-1 rounded-lg border border-white/10 bg-[#0a0e16]/60 px-4 py-5 text-center">
            ...
            <p
                className={`mt-2 font-mono text-lg font-semibold ${valueClassName}`}
            >
                {value}
            </p>
    ...
    return (
        <div className="overflow-x-auto rounded-xl border border-white/10 bg-[#0a0e16] px-5 py-5 font-mono text-[13px] leading-relaxed">
            ...
            <p className="mt-4 text-slate-500">
                ← <span className="text-emerald-400">201 Created</span> · NUBAN
                assigned
            </p>
        </div>
    )
