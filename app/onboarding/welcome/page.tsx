        ...
        <div className="min-h-screen bg-slate-100 lg:grid lg:grid-cols-[0.85fr_0.95fr]">
            <section className="relative overflow-hidden bg-slate-950 px-6 py-8 text-slate-50 sm:px-10 lg:px-14">
                ...
                <div className="relative z-10 flex min-h-full flex-col justify-between gap-10">
                    <div className="space-y-10">
                        ...
                        <div className="max-w-2xl space-y-6">
                            ...
                            <h1 className="text-4xl w-lg font-semibold leading-tight text-white sm:text-[42px]">
                                The rails behind every dedicated account you
                                issue.
                            </h1>
                        </div>
                        <div className="space-y-4">
                            <div className="flex flex-row gap-4 items-center">
                                ...
                                <div>
                                    <p className="text-xl font-normal text-white/65">
                                        Issue dedicated virtual accounts at any
                                        scale
                                    </p>
                                </div>
                            </div>
                            <div className="flex flex-row gap-4 items-center">
                                ...
                                <div>
                                    <p className="text-xl font-normal text-white/65">
                                        Real-time reconciliation webhooks in
                                        milliseconds
                                    </p>
                                </div>
                            </div>
                            <div className="flex flex-row gap-4 items-center">
                                ...
                                <div>
                                    <p className="text-xl font-normal text-white/65">
                                        Bank-grade security · NDPR & PCI-DSS
                                        aligned
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="pt-6 text-sm leading-6 text-slate-400">
                        © 2026 LDB Africa · Trusted by 40+ fintechs & MFBs ·
                        Powered by nomba
                    </div>
                </div>
            </section>
            ...
            <section className="px-10 py-16 flex items-center justify-center">
                <div className="mx-auto w-full max-w-2xl">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-slate-900">
                                    LDB Africa is all set up
                                </h3>
                                <p className="mt-1 text-sm text-slate-600">
                                    Your KYB is under review — full live access
                                    unlocks within 24 hours. You can explore the
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-slate-500">
                                        Authenticate requests with your live and
                                        test credentials.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="rounded-lg border border-slate-200 bg-white p-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-slate-500">
                                        Get real-time events the instant a
                                        customer&apos;s transfer lands.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a
                        href="/dashboard"
                        className="mt-8 inline-block w-full rounded-[12px] bg-(--color-emerald) h-12 leading-[48px] text-center font-semibold text-slate-950"
                    >
                        Go to dashboard →
                    </a>
                </div>
