...
export function OnboardingShell({
    ...
    const steps = ["Account", "Business", "Address", "Verification", "Review"]
    return (
                            ...
                            <div className="flex-1 pr-0">
                                ...
                                <div className="mt-3 flex items-center">
                                    {steps.map((label, i) => (
                                        ...
                                        >
                                            <span
                                                className={`block tracking-wide mr-16 ${i + 1 === currentStep ? "font-semibold text-slate-900" : "text-slate-400"}`}
                                            >
                                                {label}
                                            </span>
                                        </div>
