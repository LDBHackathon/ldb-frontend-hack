        ...
        <div className="min-h-screen bg-slate-100 py-10">
            <div className="mx-auto flex max-w-2xl flex-col gap-4 px-4">
                <div className="flex items-center gap-3 rounded-md border border-[#00C2A833]/90 bg-[#00C2A833]/30 px-5 py-3 text-emerald-800">
                    ...
                    <p className="text-sm">
                        Review your details before submitting for KYB
                        verification.
                    </p>
                </div>
                ...
                <div className="rounded-md bg-white p-6 shadow-sm">
                    <p className="mb-2 text-xs font-semibold uppercase tracking-[0.15em] text-emerald-600">
                        Account
                    </p>
                ...
                <div className="rounded-md bg-white p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-x-8">
                        ...
                        <div className="divide-y divide-slate-100">
                            <Field
                                label="Trading name"
                                value={data.business?.tradingName}
                            />
                            <Field
                                label="Industry"
                ...
                <div className="rounded-md bg-white p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-x-8">
                        <div className="divide-y divide-slate-100">
                            ...
                            <Field
                                label="Phone"
                                value={data.address?.businessPhone}
                            />
                        </div>
                        <div className="divide-y divide-slate-100">
                            <Field
                ...
                <div className="rounded-md bg-white p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-x-8">
                        <div className="divide-y divide-slate-100">
                            <Field
                                label="Director"
                                value={data.verification?.directorName}
                            />
                            <Field
                                label="CAC document"
                                value={data.verification?.cacDocument}
                            />
                        </div>
                        <div className="divide-y divide-slate-100">
                            <Field
                                label="BVN / ID"
                                value={data.verification?.bvnId}
                            />
                            <Field
                                label="Address proof"
                                value={data.verification?.addressProof}
                            />
                        </div>
                    </div>
                </div>
