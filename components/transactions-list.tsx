        ...
        <div className="flex items-center justify-between mb-6 px-6 py-3 bg-white">
          <div>
            ...
            <p className="text-sm text-[#64748B] mt-1">
              Deposits and withdrawals across your customers&apos; virtual accounts
            </p>
          </div>
          <Button
            variant="outline"
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <FilterDropdown
            ...
            onChange={(v) => setStatusFilter(v as TransactionStatusFilter)}
          />
        </div>
              ...
              {filteredTransactions.length === 0 ? (
                ...
                filteredTransactions.map((txn) => (
                  ...
                  >
                    ...
                    <TableCell className="px-4">
                      <AmountCell type={txn.type} amount={txn.amount} />
                    </TableCell>
                    <TableCell className="px-4">
