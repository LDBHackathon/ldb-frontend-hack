        ...
        <div className="space-y-6">
            ...
            <Card className="border border-slate-200 bg-white p-6 md:p-8">
                ...
                <p className="text-sm text-slate-500 mb-6">
                    Use a strong, unique password. We recommend at least 12
                    characters.
                </p>
          ...
          Kept as static UI; wire up once a real sessions endpoint exists. */}
            <Card className="border border-slate-200 bg-white p-6">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-teal-50 text-teal-700 hover:bg-teal-50 border-0">
                            This device
                        </Badge>
                    </div>
            ...
            <Card className="border border-red-200 bg-red-50/30 p-6">
                ...
                <p className="text-sm text-slate-500 mb-4">
                    Deactivating suspends all API access and webhooks for your
                    organization.
                </p>
            </Card>
        </div>
